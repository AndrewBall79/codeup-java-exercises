...
//String name = "Fortuna";
//        System.out.printf("Hello %s%n", name);//prints name and format
//        System.out.printf("Hello %S%n", name);//prints name and format to uppercase
...
//
//        System.out.printf("My Name Is %s%n", MyName);//printf formats
//
//
//        // TODO: print using printf() with placeholder %S
//        System.out.printf("My nanananame Is %S%n", MyName);
...
//        System.out.printf("I have %d %s%n", typeOfPet, three);
        ...
        int keepTheChange = 8900;
        System.out.printf("If You Have $%.2f Ill give you this car.", keepTheChange/100.00);
