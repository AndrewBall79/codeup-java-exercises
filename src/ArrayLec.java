...
//        System.out.println(horns[randInt] + " is the best horn!");
        ...
        Instructor vv = new Instructor("V","V");
        Instructor trant = new Instructor("Trant", "Batey");

// set bwave freq

        casey.setBrainWaveFreq(55000);
        vv.setBrainWaveFreq(55000);
        trant.setBrainWaveFreq(51000);


        // iterate through each one and display their stats
        ...
        Arrays.fill(firstNames, "haXXorz");
        for(String name : firstNames){
            System.out.println("\t" + name);
        }
        System.out.println(Arrays.toString(team));

        //sum all the instructor freqs
        int freqSum = 0;

        for(Instructor instructor : team){
            freqSum += instructor.getBrainWaveFreq();
        }
